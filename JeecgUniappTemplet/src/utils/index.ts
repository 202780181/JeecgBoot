 ...
 * redirectPath 如 ‘/pages/index/index’
 */
export const currRoute = () => {
  ...
  // eg: /pages/login/login?redirect=%2Fpages%2Findex%2Findex (小程序)
  // eg: /pages/login/login?redirect=%2Fpages%2Findex%2Findex%3Fname%3Djeecg(h5)
 ...
 * 比如输入url: /pages/login/login?redirect=%2Fpages%2Findex%2Findex
 * 输出: {path: /pages/login/login, query: {redirect: /pages/index/index}}
 */
